...
public class WMLSamples
{
    ...
    private static String CreateAndDeployDietPythonModel(Connector wml)
    {
        ...
        String model_id = wml.CreateNewModel("Diet", Runtime.DO_12_10, ModelType.DOCPLEX_12_10, path);
    ...
    static String CreateAndDeployLPModel(Connector wml)
    {
        ...
        String model_id = wml.CreateNewModel("location", Runtime.DO_12_9, ModelType.CPLEX_12_10, path);
        logger.Info("model_id = " + model_id);
    ...
    static String CreateAndDeployWarehouseOPLModel(Connector wml)
    {
        ...
        String model_id = wml.CreateNewModel("Warehouse", Runtime.DO_12_9, ModelType.OPL_12_9, path);
        logger.Info("model_id = " + model_id);
